...
('admin', 'a@a.com', '${hash}'),
('James', 'James@a.com', '${hash}'),
('Jacob', 'Jacob@a.com', '${hash}'),
('SuperSOC', 'SuperSOC@a.com', '${hash}'),
('Chalres', 'Chalres@a.com', '${hash}'),
('Gaia', 'Gaia@a.com', '${hash}'),
('Zues', 'Zues@a.com', '${hash}'),
('Thomas', 'Thomas@a.com', '${hash}'),
('Jane', 'Jane@a.com', '${hash}'),
('Baksa', 'Baksa@a.com', '${hash}'),
('kealn', 'kealn@a.com', '${hash}'),
('Shaun', 'Shaun@a.com', '${hash}');
